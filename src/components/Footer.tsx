    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:info@fcrit.ac.in">info@fcrit.ac.in</a>
              </li>
              <li className="flex items-center">
                <Phone size={16} className="mr-2" />
                <a href="tel:+912227771000">+91 22 2777 1000</a>
              </li>
              <li className="flex items-center">
                <MapPin size={16} className="mr-2" />
                <span>Sector 9-A, Vashi, Navi Mumbai, Maharashtra 400703</span>
              </li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 text-center">
          <p>&copy; 2024 Fr. Conceicao Rodrigues Institute of Technology. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
